...
mixin _$LoginStore on _LoginStore, Store {
  ...
  bool get isFormValid =>
      (_$isFormValidComputed ??= Computed<bool>(() => super.isFormValid,
          ...
          .value;
  Computed<bool>? _$onPressedComputed;

  @override
  bool get onPressed => (_$onPressedComputed ??=
          Computed<bool>(() => super.onPressed, name: '_LoginStore.onPressed'))
      .value;
  ...
  dynamic setNome(String value) {
    final _$actionInfo =
        _$_LoginStoreActionController.startAction(name: '_LoginStore.setNome');
    try {
