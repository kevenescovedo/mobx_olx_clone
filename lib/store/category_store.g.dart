...
mixin _$CategoryStore on _CategoryStore, Store {
  Computed<List<Category>>? _$allCateogryListComputed;

  @override
  List<Category> get allCateogryList => (_$allCateogryListComputed ??=
          Computed<List<Category>>(() => super.allCateogryList,
              name: '_CategoryStore.allCateogryList'))
      .value;
  ...
  String toString() {
    return '''
allCateogryList: ${allCateogryList}
    ''';
  }
}
